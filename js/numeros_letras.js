document.getElementById("contrato__monto").addEventListener("keyup",function(e){
    document.getElementById("contrato__monto__letras").innerHTML=numeroALetras(this.value);
